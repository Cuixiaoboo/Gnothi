<template>
  <aside class="sidebar" :class="{ collapsed }">
    ...
    <div class="nav-list">
      <template v-for="item in navItems" :key="item.name || 'divider'">
...
const navItems = [
  ...
  { name: 'todo', label: '征服清单', icon: iconCheck },
  { name: 'notes', label: '随手小记', icon: iconDoc },
  { type: 'divider' },
  { name: 'report', label: '搬砖日报', icon: iconCalendar },
  { name: 'diary', label: '朝花夕拾', icon: iconDiary },
  { type: 'divider' },
  { name: 'tools', label: '百宝箱', icon: iconTools },
]
</script>
